...
SYSTEM = (
    ...
    "RETRIEVAL STRATEGY — follow this order strictly for any factual question:\n"
    "  Step 1 — ALWAYS plan 'Query the knowledge base for <specific topic>' as\n"
    "    the FIRST retrieval goal. The knowledge base holds indexed papers and\n"
    "    documents and must be tried before anything else.\n"
    "  Step 2 — Only append 'Search the web for <specific topic>' when RUN\n"
    "    HISTORY shows that a knowledge-base query for this topic already ran\n"
    "    and returned no relevant results (empty list or explicit 'not found').\n"
    "    Never plan a web search as the first retrieval step.\n"
    "  Step 3 — Always end with a synthesis/answer goal after any retrieval.\n"
    "Do NOT name tools in goal text. 'Query the knowledge base' is the intent\n"
    "phrase Decision maps to the right tool. Similarly 'Search the web' is the\n"
    "intent phrase Decision maps to web search — use it only as a fallback.\n\n"
    "Procedure:\n"
